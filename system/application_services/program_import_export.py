...
class ProgramExportHandler:
    ...
    def _annotate_with_files(self):
        """
        Here we add the program cover image id and all the unique file ids we found to the program instance
        """
    ...
    def _annotate_with_variables(self):
        """
        Here we add all the unique variable names we found to the program instance
        """
